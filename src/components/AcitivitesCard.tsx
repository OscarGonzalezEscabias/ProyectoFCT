            ...
            <div className="p-6">
                <div className="flex justify-between items-start mb-3">
                    <div>
                        ...
                        <span
                            className={`text-xs font-medium mt-1 inline-block px-2 py-1 rounded ${activities.types === "RENTING"
                ...
                <p className="text-gray-600 text-sm mb-4">{activities.description}</p>
                ...
                <div className="flex justify-between items-center mb-4">
                    ...
                    <span
                        className={`text-sm font-semibold ${activities.available ? "text-green-600" : "text-red-500"
                            }`}
                    >
